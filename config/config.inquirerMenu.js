...
let configCvContent = {};
try {
  configCvContent = (await import("../config/config.cvContent.js"))
    .configCvContent;
} catch (e) {
...
const cvContent =
  Object.keys(configCvContent).length > 0 ? configCvContent : defaultCvContent;
...
const subtitleAsciiText =
  "  Hello, my name is Arthur Ersosi. Welcome to my resume!";
